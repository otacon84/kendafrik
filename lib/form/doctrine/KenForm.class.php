 ...
 */
class KenForm extends BaseKenForm
{                                                                                                                                
  ...
  //VALIDATORS
    ...
    $this->validatorSchema['ville'] = new sfValidatorString(array('required' => false, 'max_length' => 40, 'min_length' => 2), 
    ...
    $this->validatorSchema['supplement'] = new sfValidatorString(array('required' => false,'min_length' => 4,'max_length' => 200), array(
        'min_length' => 'Le message est trop court. Il faut au moins %min_length% caractères.',
        'max_length' => 'Le message est trop long. Il faut au plus %max_length% caractères.',        
      ));    
